...
function signSessionToken(role: "organizer" | "team" | "judge", id: string): string {
...
function verifySessionToken(token: string, expectedRole: "organizer" | "team" | "judge"): string | null {
